...
public class Merge {
	...
	// Precondition: a is Comparable arrays, aux is Comparable array, lo is an
	// integers, mid is an integer, hi is an integer.
	// --------------------------------------------------------
	{
		for (int k = lo; k <= hi; k++)
			aux[k] = a[k];
	...
	// --------------------------------------------------------
	// Summary: It is creating an auxiliary array. Then, It sends the auxiliary
	// array and
